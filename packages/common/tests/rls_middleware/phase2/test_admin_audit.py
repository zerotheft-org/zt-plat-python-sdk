...
from common.rls_middleware.infrastructure.audit_logger import AuditLogger
from tests.rls_middleware.phase2.conftest import ADMIN_USER, TENANT_A, TRACE_SEED_A
...
class TestAuditEventVisibility:
    ...
    def test_raw_session_sees_all_audit_events(self, raw_session):
        ...
        """
        from tests.rls_middleware.phase2.conftest import TRACE_SEED_SYSTEM
